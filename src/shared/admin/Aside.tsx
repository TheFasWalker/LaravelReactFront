    ...
    >
      <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul className="space-y-2">
          ...
          />
          <DropDown
            title="dropDownTitle222"
            linksData={
              [{
                'name': 'DropDown item12',
                'link': '#'
              }, {
                'name': 'DropDown item 22',
                'link': '#'
              }]
            }
          />
        ...
        >
          <li>
            ...
            >
              ...
              <span className="ml-3">Посты</span>
            </NavLink>
          </li>
          <li>
            <NavLink
          ...
          <li>
            ...
            >
              ...
              <span className="ml-3">Фирмы</span>
            </NavLink>
          </li>
        </ul>
      </div>
