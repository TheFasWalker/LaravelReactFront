...
export const Tags = () => {
  ...
  const { isLoading, data, error } = useAppSelector((state) => state.tagsReduser)
      ...
      <div className="mx-auto max-w-screen-xl px-4 lg:px-12 relative">
        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          ...
          <div className="overflow-x-auto">
            {error && <span className=" w-full flex items-center justify-center py-6 bg-red-300 text-bold text-5xl">{error}</span>}
            {(!data.data.length && !error) && (<h1> Список тэгов пуст</h1>)}
            {!error && (
